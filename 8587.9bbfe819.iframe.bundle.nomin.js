"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[8587],{
...
class SelectFilter extends react.Component {
  ...
  getScreenReaderText(filter, config) {
    ...
    const value = (0,lodash.find)(config.input.options, {
      value: filter.value
    }) || {};
...
class SearchFilter extends react.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (filter.value.length && !(0,lodash.isEqual)(prevFilter, filter)) {
      ...
      const filterIds = (0,src/* getIdsFromQuery */.DF)(filter.value);
...
;
NumberFilter.__docgenInfo = {
  "description": "",
  "methods": [{
    "name": "getBetweenString",
    "docblock": null,
    "modifiers": [],
    "params": [],
    "returns": null
...
const getScreenReaderText = ({
  ...
  const filterStr = backwardsCompatibleCreateInterpolateElement(/* eslint-disable-next-line max-len */
...
const AttributeFilter = props => {
  ...
  const [selectedAttributeTerm, setSelectedAttributeTerm] = (0,react.useState)(Array.isArray(value) ? value[1] || '' : '');
...
class AdvancedFilters extends react.Component {
  constructor({
    ...
    this.filterListRef = (0,react.createRef)();
...
;
AdvancedFilters.__docgenInfo = {
  "description": "Displays a configurable set of filters which can modify query parameters.",
  "methods": [{
    "name": "getInstanceNumber",
    "docblock": null,
    "modifiers": [],
    "params": [{
      "name": "key",
...
TextControlWithAffixes.displayName = "TextControlWithAffixes";
